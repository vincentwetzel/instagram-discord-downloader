...
powershell -Command "Get-CimInstance Win32_Process -Filter \"CommandLine Like '%%instagram_discord_downloader_bot.py%%'\" | Invoke-CimMethod -MethodName Terminate" >nul 2>&1
...
start "" pythonw instagram_discord_downloader_bot.py
